...
async function initializeDatabase() {
    try {
        ...
        const migrationPath = path_1.default.join(__dirname, '../database/migrations/001_china_box_and_futian.sql');
...
async function seedDefaultData(client) {
    ...
    if (adminExists.rows.length === 0) {
        ...
        const adminHash = bcryptjs_1.default.hashSync('AdminPassword123!', 10);
        const staffHash = bcryptjs_1.default.hashSync('StaffPassword123!', 10);
        const custHash = bcryptjs_1.default.hashSync('CustomerPassword123!', 10);
        // Users

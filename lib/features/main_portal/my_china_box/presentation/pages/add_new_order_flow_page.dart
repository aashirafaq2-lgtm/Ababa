...
const _kSites = [
  _ShoppingSite(
    ...
    nameEn: 'China',
    flagEmoji: '🇨🇳',
    platformsAr: 'منصات التجارة والمصانع المعتمدة',
    platformsEn: 'Direct Factory & Wholesale Hubs',
  ...
  _ShoppingSite(
    id: 'shein',
    nameAr: 'أزياء وماركات',
    nameEn: 'Fashion & Retail',
    flagEmoji: '🛍️',
    platformsAr: 'مواقع الماركات والتسوق العالمية',
    platformsEn: 'Global Brand & Retail Portals',
